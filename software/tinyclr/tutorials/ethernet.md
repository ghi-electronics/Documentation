...
static void W5500Test() {
    ...
    networkController.NetworkAddressChanged += On_NetworkAddressChanged;
    ...
    networkController.Enable();
     ...
     while (isReady == false) ; // wait for connection success
...
private static void On_NetworkAddressChanged(INetworkInterface sender, W5500Controller.NetworkAddressChangedEventArgs e) {
    var networkController = (W5500Controller)sender;

    Debug.WriteLine("IP Address : " + networkController.Address);
    Debug.WriteLine("netmask : " + networkController.SubnetMask);
    Debug.WriteLine("gateway : " + networkController.GatewayAddress);
    Debug.WriteLine("primary dns : " + networkController.PrimaryDnsServer);
