...
> [!Tip]
> Not recommended for new designs, consider SITCore [System on Chip](system-on-chip.md).
...
1. GHI Bootloader: initializes the system, updates NETMF firmware when needed, and executes NETMF.
...
You can also update the firmware manually. See [GHI Bootloader](../../hardware/loaders/ghi-bootloader.md) manually.
