...
Download the [G400 bootloader v2 file](../../software/netmf/bootloader.md) and load onto the dataflash using the Microchip (Atmel) [SAM-BA tool](https://www.microchip.com/developmenttools/ProductDetails/PartNO/SAM-BA%20In-system%20Programmer) and the following instructions.
