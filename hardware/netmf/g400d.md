...
Download the [G400 bootloader v2 file](../../software/netmf/bootloader.md) and load onto the dataflash. The [SAM-BA Bootloader](../../hardware/loaders/sam-ba-bootloader.md) has the details.
...
You can also update the firmware manually. Download the [firmware](../../software/netmf/downloads.md) and learn how to use the [GHI Bootloader](../../hardware/loaders/bootloader.md) manually.
