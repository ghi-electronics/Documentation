...
You can also update the firmware manually. Download the [firmware](../../software/netmf/downloads.md) and learn how to use the [GHI Bootloader](../../software/netmf/bootloader.md) manually.
